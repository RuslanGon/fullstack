  ...
  return (
    <form onSubmit={(e) => e.preventDefault()} className="w-1/3 mx-auto py-10">
      ...
      <div className="flex gap-8 items-center justify-center mt-4">
        <button onClick={submitHandle} className="flex items-center justify-center bg-gray-600 text-xs text-white rounded-sm py-2 px-4 cursor-pointer">Добавить пост</button>
